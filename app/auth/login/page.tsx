 ...
 * Fix: Removed JSX comments from inside attribute lists (caused syntax error).
 *      Comments are now ABOVE the tags they describe.
 */
    ...
    <div className="flex flex-col w-full h-full">
      ...
      <div className="flex-1 flex items-center justify-center px-8 lg:px-10">
        <div className="w-full max-w-[320px]">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: C.grey }}>
          ...
          <p className="mt-5 text-center text-sm" style={{ color: C.grey }}>
            ...
            <Link href="/auth/sign-up" className="font-bold hover:underline underline-offset-4" style={{ color: C.carbon }}>
              Start free trial
            </Link>
          </p>
        </div>
      ...
      <div className="flex items-center justify-between px-8 lg:px-10 py-4 flex-shrink-0 border-t"
        ...
        <div className="flex items-center gap-4">
          <Link href="/pricing" className="hover:text-neutral-600 transition-colors">Plans</Link>
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-white">
      ...
      <div className="hidden lg:block relative flex-shrink-0" style={{ width: "60%" }}>
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, rgba(6,6,8,0.3) 0%, transparent 35%, rgba(6,6,8,0.82) 100%)" }} />
        <div className="absolute inset-0" style={{ background: "linear-gradient(to right, rgba(6,6,8,0.0) 0%, rgba(6,6,8,0.1) 50%, rgba(6,6,8,0.65) 100%)" }} />

        {/* Logo + tagline — bottom right */}
        <div className="absolute bottom-10 right-8" style={{ textAlign: "right" }}>

          {/*
            LOGO SIZE — to resize change the width and height numbers below.
            Options:
              Small    → 52
              Medium   → 65
              Current  → 78  (this is +50% from the original 52px)
              Large    → 96
              XLarge   → 120
          */}
          <div className="flex justify-end mb-3">
            <img
              src="/condor-logo-v1.png"
              alt=""
              width={78}
              height={78}
          ...
          {/*
            OLD logo style (frosted glass container) — uncomment block below to restore:
          ...
          */}
          ...
          {/* Tagline — whiteSpace nowrap = single line, no break */}
          <p style={{
            ...
            From data to{" "}
            <span style={{ color: "rgba(255,255,255,0.5)", fontWeight: 600 }}>understanding.</span>
          </p>
          ...
          <p className="mt-3" style={{
            ...
            The B2B analytics platform for marketers<br />
